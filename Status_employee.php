...
if(isset($_REQUEST['submit'])){
  ...
  $names = mysqli_query($con, "SELECT * FROM tbl_employee WHERE no like '%$search%'");
...
<div class="col=7">
    <h1>Municipality of Tuy Batangas</h1>
            <div class="home-content">
                  <div class="container">
                  <div class="title">Create Status Form for Employee</div>
                  <div class="content">
                    <form method="POST">
...
<input type="text" name="no1" value="<?php echo $list['no']; error_reporting(E_ALL ^ E_WARNING);?>" disabled>
...
<button type="submit" class="btn btn-success"><a href="HOME_PAGE_INFORMATION_OFFICER2.php" style = "color:white"><h6>Home Page</a></h6></button>
</div>
</div>
</div>
</div>
...
if(isset($_REQUEST['enter'])){
  ...
  $insertQuery = mysqli_query($con, "INSERT INTO tbl_employee_updated VALUES ('$no2', '$name2', '$address2', '$contact2', '$time2', '$a_date2', '$status2')");
 ?>
<div class="alert1">
<script type="text/javascript">
      window.location = "HOME_PAGE_INFORMATION_OFFICER2.php";
    </script>
    </div>
<?php
