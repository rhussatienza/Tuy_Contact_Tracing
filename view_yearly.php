...
<div style="background: linear-gradient(-135deg, forestgreen, darkseagreen);"class="container p-2 text-white">
  <h4>Yearly report for the number of People that went to the municipal hall and number of people who cancelled and missed to enter the municipal hall</h4>
</div>
...
<?php
$thdate = $_GET['thdate'];
  $sql = mysqli_query($con, "SELECT * FROM tbl_brgy_yearly WHERE a_date = '$thdate'");
...
<tbody>
  ...
  <tr>
    ...
    <tr>
    <td data-label="Barangay" style="color:red;"><b>CANCELLED APPOINTMENT</b></td>
    <td data-label="Number" style="color:red;"><?php echo $rec['cancelled']; ?></td>
  </tr>

  <tr>
    <td data-label="Barangay" style="color:red;"><b>MISSED APPOINTMENT</b></td>
    <td data-label="Number" style="color:red;"><?php echo $rec['missed']; ?></td>
  </tr>
</tr>
</tbody>
</table>
...
<br>
<div class="signature">
<img src="Images/e-sig.png" alt="">
</div>
<div class="signature_text">
<p>Prepared by: <?php error_reporting(E_ALL ^ E_WARNING); echo $name['name']; ?></hp>
</div>
...
<button type="submit"><h6>Go to Home Page</h6></bu
tton></form>
</div>
</div>
