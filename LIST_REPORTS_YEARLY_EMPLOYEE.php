...
<div style="background: linear-gradient(-135deg, forestgreen, darkseagreen); "class="container p-2 text-white">
  <h4>Overall List of employee every year who enter the Municipal Hall</h4>
</div>
...
<?php
	$sql = mysqli_query($con, "SELECT * FROM tbl_brgy_yearly_employee");
	while($list = mysqli_fetch_assoc($sql)){?>

  <tbody>
	<tr>
    <td data-label="Date"><?php echo $list['a_date']; ?></td>
    <td data-label="View"><a href="view_yearly_employee.php?thdate=<?php echo $list['a_date']; ?>"><img src="Images/viewicon.png"></a></td>
		</tr>
  </tbody>
  ...
  <div class="buttonHolder">
    <form action="YEARLY_REPORTS_EMPLOYEE.php">
