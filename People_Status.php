  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="Create_Status.php">
            <i class='bx bx-calendar-check' ></i>
            <span class="links_name">Status</span>
          </a>
        </li>
        <li>
          <a href="People_Status.php">
            <i class='bx bx-calendar-check' ></i>
            <span class="links_name">People Status</span>
          </a>
        </li>
...
?>
    ...
    <table class="table">
      ...
      <tr>
        <th><b>ID. No</b></th>
        <th><b>Resident's Full Name</b></th>
        <th><b>Status</b></th>
        </tr>
      </thead>  
      </form>
...
if(isset($_REQUEST['SEARCH'])){
  ...
  if($_POST['name'] == NULL){
     ...
     <script type="text/javascript">
            setTimeout(function () { 
            swal({
              title: "Please Enter Name!<?php echo $ids['num'] ?>",
              text: "",
              type: "error",
  ...
  $S =mysqli_query($con, "SELECT * FROM tbl_people_updated WHERE a_date = CURDATE() AND name LIKE '%$search%'");
  ?>
...
$sql = mysqli_query($con, "SELECT * FROM tbl_people_updated WHERE a_date = CURDATE()");
