...
<div style="background: linear-gradient(-135deg, forestgreen, darkseagreen);"class="container p-2 text-white">
  <h4>Weekly report for the number of People that went to the municipal hall and number of people who cancelled and missed to enter the municipal hall</h4>
</div>
...
<?php
$thdate = $_GET['thdate'];
  $sql = mysqli_query($con, "SELECT * FROM tbl_brgy_weekly WHERE a_date = '$thdate'");
