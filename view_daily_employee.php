...
<div style="background: linear-gradient(-135deg, forestgreen, darkseagreen);"class="container p-2 ">
  <h4>Daily report for the number of employee that went to the municipal hall and number of people who cancelled and missed to enter the municipal hall</h4>
</div>
...
<div class="table-container">
    <table class="table">
      ...
      <tr>
        ...
        </tr    @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@200;300;400;500;600;700&display=swap');
.page-holder{
  min-height: 100vh;
}   
body{
...
<?php
$thdate = $_GET['thdate'];
  $sql = mysqli_query($con, "SELECT * FROM tbl_brgy_employee WHERE a_date = '$thdate'");
