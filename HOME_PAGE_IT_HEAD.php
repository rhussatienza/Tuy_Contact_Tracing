    ...
    <div class="home-content">
      ...
      <div class="employee-report">
        ...
        <div class="employee-report">
          ...
          <button type="enter" >Employee Reports</button></form>
          
          
      </div>
      <div class="employee-report">
          <form action="image.php">
          <button type="submit">Add Image</button></form>
      </div>
      <div class="employee-report">
      <form action ="HOME_PAGE_IT_HEAD.php">
          <button type="submit">View Records</button></form>
...
if(isset($_REQUEST['SEARCH'])){
  ...
  if($_POST['a_date'] == NULL){
     ...
     <script type="text/javascript">
            ...
            function(isConfirm){
              if (isConfirm) {
            window.location.href = "HOME_PAGE_IT_HEAD.php";
              }
            }); }, 5);
    </script>
  <?php
  ...
  $S =mysqli_query($con, "SELECT * FROM tbl_people_updated WHERE status = 'Successful Appointment' AND a_date LIKE '%$search%'");
  $S1 =mysqli_query($con, "SELECT COUNT(*) AS num FROM tbl_people_updated WHERE  status = 'Successful Appointment' AND a_date LIKE '%$search%'");
...
$sql = mysqli_query($con, "SELECT * FROM tbl_people_updated WHERE status = 'Successful Appointment' AND a_date = CURDATE()");
