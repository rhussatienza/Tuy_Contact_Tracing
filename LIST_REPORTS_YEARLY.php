...
<?php
	$sql = mysqli_query($con, "SELECT * FROM tbl_brgy_yearly");
	while($list = mysqli_fetch_assoc($sql)){?>

  <tbody>
	<tr>
    <td data-label="Date"><?php echo $list['a_date']; ?></td>
    <td data-label="View"><a href="view_yearly.php?thdate=<?php echo $list['a_date']; ?>"><img src="Images/viewicon.png"></a></td>
		</tr>
  </tbody>
  ...
  <div class="buttonHolder">
    <form action="YEARLY_REPORTS.php">
