...
<?php
    ...
    <th class="center">
    <center><a href="view.php?thdate=<?php echo $list['a_date']; ?>"><img src="Images/viewicon.png" width=30 height=30 border=0></a></center>
...
<button type="submit" class="btn btn-light"><h6 style = "color:black">Back to IT Home Page</button></form>
