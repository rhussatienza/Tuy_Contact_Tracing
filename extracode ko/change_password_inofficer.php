...
<div class="container">
  <div class="row d-flex justify-content-center">
    ...
    <form name="frmChange" method="post" action=""
        ...
        <div style="width: 500px;">
            ...
            <center><h2><span class="badge badge-warning">CHANGE PASSWORD <br>(INFORMATION OFFICER)</br></span></h2></center>
  ...
  $confirmPassword = mysqli_real_escape_string($con, $_POST['confirmPassword']);
        ...
        $result = mysqli_query($con, "SELECT * from tbl_account_information_officer WHERE username = '$username'");
      ...
      window.location = "change_password_inofficer.php";
      </script>
...
?>
<center><a href = "login_info_officer.php">Go to Login Page</a></center>
</body>
</html>
