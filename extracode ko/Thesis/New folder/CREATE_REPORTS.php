...
<tr>
		<td>Acle:</td>
		<td><input type="number" name="acle" placeholder="Enter number of cases..." required></td>
	</tr>
</div>
<div class="form-group">
<tr>
...
<tr>
		<td>Mun. Hall</td>
		<td><input type="number" name="hall" placeholder="Enter number of people in municipal hall..." required></td>
	</tr>
	</div>
...
<tr>
		<td>Date:</td>
		<td><input type="text" name="a_date" placeholder="YYYY-MM-DD" required></td>
	</tr>
	</div>     

<div class="form-group">
<tr>
	<td colspan=2 align=""><input type="submit" name="submit" value="SUBMIT" onsubmit="validation()"></tr>
	</div>
...
?>
                  ...
                  <button type="submit" class="btn btn-success"><h6 style = "color:white">See Daily Reports</button></form>
